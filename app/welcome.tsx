...
export default function WelcomeScreen() {
  return (
    <View className="flex-1 bg-purple-800 px-8 justify-center items-center">
      {/* Header */}
      ...
      {/* Content */}
      <View className=" px-6 py-8 bg-orange-400 w-full" style={{ borderRadius: 50 }}>
      ...
      <View className="gap-y-4 mt-12 w-full px-6">
        <TouchableOpacity
          ...
          className="bg-orange-400 py-4 px-6 rounded-full"
        >
        ...
        <TouchableOpacity
          ...
          className="bg-white border-2 border-orange-400 py-4 px-6 rounded-full"
        >
          <Text className="text-orange-400 text-lg font-montserrat-medium text-center">
      ...
      <TouchableOpacity
        ...
        className="mt-6"
      >
        <Text className="text-orange-400 font-montserrat text-center">
